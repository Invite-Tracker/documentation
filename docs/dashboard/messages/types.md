...
View all the different invite and message types.
...
**1:** Invite Tracker can not see the channel to which the invite was directed. (Permission problem which can be fixed easily by giving admin to Invite Tracker)
